 ...
 * @author nursalim
 */
public class ListOfValuesCustomer extends javax.swing.JDialog {
    ...
    public ListOfValuesCustomer(java.awt.Frame parent, boolean modal, Map data) {
        super(parent, modal);
        initComponents();
...
//        dataTable.getColumnModel().getColumn(0).setMaxWidth(50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListOfValuesCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListOfValuesCustomer dialog = new ListOfValuesCustomer(new javax.swing.JFrame(), true, null);
