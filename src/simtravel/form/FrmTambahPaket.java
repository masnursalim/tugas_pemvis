 ...
 * @author nursalim
 */
public class FrmTambahPaket extends javax.swing.JDialog {
    ...
    public FrmTambahPaket(java.awt.Frame parent, boolean modal, Map data) {
        super(parent, modal);
    ...
    public void tambahRecord(){
        String sql = "INSERT INTO tbl_paket_umrah(nama_paket, hotel, maskapai, transportasi, fasilitas, harga) VALUES (?, ?, ?, ?, ?, ?) ";
        try {
            ps = con.prepareStatement(sql);
    ...
    public void updateRecord(){
        String sql = "UPDATE tbl_paket_umrah SET hotel = ?, maskapai = ?, transportasi = ?, fasilitas = ?, harga = ? WHERE nama_paket = ? ";
        con = new DBUtils().getKoneksi();
        try {
            ps = con.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTambahPaket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmTambahPaket dialog = new FrmTambahPaket(new javax.swing.JFrame(), true, null);
